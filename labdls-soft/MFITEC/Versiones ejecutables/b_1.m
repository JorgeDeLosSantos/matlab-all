...
boton=uicontrol(pp,'style','pushbutton','String','Calcular','position',[150 20 100 30],...
    'callback',{@calcular,subtipo},'fontsize',10,'fontweight','bold');

%% Menú abajo

% simb=uicontrol('style','pushbutton','String','Notación','position',[0 0 100 30],...
%     'callback',@some,'fontsize',10,'fontweight','bold','backgroundcolor',[0.8 0.9 0.8]);
...
graphs=uicontrol('style','pushbutton','String','','position',[0 posb-35 35 35],...
...
% inim=helpdlg('Proporcione los datos indicados','Bienvenido...');
