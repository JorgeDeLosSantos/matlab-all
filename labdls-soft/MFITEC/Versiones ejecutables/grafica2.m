function grafica2(x,y,xlab,ylab,nota)
% % --------------------------------------------------
% x=[0:0.01:10];
% y=cos(x);
% z=sin(x/10);
% xlab='Smitx';ylab='Fity';encab='Title';
% --------------------------------------------------
if any(isnan(x)) | any(isnan(y))
    ...
    xlabel(xlab,'fontweight','b','fontname','Arial','fontsize',9);
    ylabel(ylab,'fontweight','b','fontname','Arial','fontsize',9);
    title('MFITEC');
    legend(nota);
...
%% Funciones
    ...
    function gtabla(src,event,xlab,ylab)
        warndlg('Herramienta no disponible','MFITEC');
    end
