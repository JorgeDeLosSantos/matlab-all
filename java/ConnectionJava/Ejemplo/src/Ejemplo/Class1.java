...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    /**
     * Maintains information used in calling the <code>HolaMundo</code> M-function.
     */
    private static final MWFunctionSignature sHolaMundoSignature =
        new MWFunctionSignature(/* max outputs = */ 0,
                                /* has varargout = */ false,
                                /* function name = */ "HolaMundo",
                                /* max inputs = */ 0,
                                /* has varargin = */ false);
    ...
    {
        this(EjemploMCRFactory.newInstance());
    }
    ...
    {
        this(EjemploMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(EjemploMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = EjemploMCRFactory.newInstance();
            mcr.runMain( sHolaMundoSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Provides the interface for calling the <code>HolaMundo</code> M-function 
     ...
     */
    public void HolaMundo(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sHolaMundoSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void HolaMundo(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sHolaMundoSignature);
    }

    /**
     * Provides the standard interface for calling the <code>HolaMundo</code>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] HolaMundo(Object... rhs) throws MWException
    {
        Object[] lhs = new Object[0];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sHolaMundoSignature), 
                    sHolaMundoSignature);
        return lhs;
    }
}
