...
%n=num2cell(precio);
n=num2cell(num2str(precio));
dim=length(n);
%valor=str2double(precio);
%% 1D
if dim==1
    uni=cell2mat(n(1));
    switch uni
...
if dim==2
    ...
    PLetra=horzcat(cad2,' ',cad1,' PESOS');
end
%% 3D
if dim==3
    uni=cell2mat(n(3));
    ...
    PLetra=horzcat(cad3,' ',cad2,' ',cad1,' PESOS');
end
%% 4D
if dim==4
    uni=cell2mat(n(4));
    ...
    PLetra=horzcat(cad4,' ',cad3,' ',cad2,' ',cad1,' PESOS');
end
...
if dim>1 & strcmp(n(dim-1),'1')==1 & strcmp(n(dim),'0')==0
    ...
    switch dim
        case 2
            PLetra=horzcat(cade1,' PESOS');
        case 3
            PLetra=horzcat(cad3,' ',cade1,' PESOS');
        case 4
            PLetra=horzcat(cad4,' ',cad3,' ',cade1,' PESOS');
    end
end
if precio==100,PLetra=horzcat('CIEN',' PESOS');
if dim>2 & strcmp(n(dim-2),'1')==1 & strcmp(n(dim-1),'0')==1 & strcmp(n(dim),'0')==0
     ...
     switch dim
        case 3
            PLetra=horzcat(cad3,' ',cade2,' PESOS');
        case 4
            PLetra=horzcat(cad4,' ',cad3,' ',cade2,' PESOS');
     end
end
